...
function startup(width, height)
{
	...
	tower = new Image();
    tower.src = getImage('/visualizers/towerDefense/Tower.png');
	
	gold = new Image();
	gold.src = getImage('/visualizers/towerDefense/Gold.png');
	
	player1 = new Image();
	player1.src = getImage('/visualizers/towerDefense/PlayerTW1.png');
	
	player2 = new Image();
	player2.src = getImage('/visualizers/towerDefense/PlayerTW2.png');
	
	cannonFirst = new Image();
	cannonFirst.src = getImage('/visualizers/towerDefense/cannonFirst.png');
	
	cannonSecond = new Image();
	cannonSecond.src = getImage('/visualizers/towerDefense/cannonSecond.png');
	
	cannonThird = new Image();
	cannonThird.src = getImage('/visualizers/towerDefense/cannonThird.png'); 
